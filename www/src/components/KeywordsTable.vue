...
const columns = [
    {
        ...
        display: (row: any) => linkify(`/keyword/${row.id}`, `#${row.id}`),
    },
    {
        label: "Created", field: "timestamp", width: "10%", sortable: true,
    ...
    {
        label: "Value", field: "value", width: "50%", sortable: true,
    },
    {
        label: "Consulted", field: "lastConsulted", width: "10%", sortable: true,
        display: (row: any) => timestampify(row.lastConsulted),
    },
]
</script>