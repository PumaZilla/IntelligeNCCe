...
const notificationData = [
  {
    icon: "fas fa-file-pdf text-theme",
    title: "'NCCG-072' REPORT GENERATED",
    time: "JUST NOW",
  },
  {
    icon: "fas fa-ambulance text-theme",
    title: "HIGH RISK EVENT FOUND",
    time: "5 MINUTES AGO",
  },
  {
    icon: "fas fa-user-plus text-theme",
    title: "ADDED TO 'NCCG-072' PROJECT",
    time: "1 HOUR AGO",
  },
];
    ...
    <div class="brand">
      <RouterLink to="/" class="brand-logo">
        ...
        <span class="brand-text"
          >INTELLIGE<span class="text-theme">NCC</span>E</span
        >
      </RouterLink>
    </div>
    <!-- END brand -->
